        ...
        <section class="project-section sec-pad portfolio-page-2">
            <div class="auto-container">
                <div class="upper-box">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 text-column">
                            <div class="text">
                                <p>SENTEC has won and successfully executed major contracts in water heating and solar power to various kinds of clients. Below are some of them.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sortable-masonry">
                    <div class="filters">
                        <ul class="filter-tabs filter-btns clearfix">
                            ...
                            <li class="filter" data-role="button" data-filter=".innovation">Innovation</li>
                            <li class="filter" data-role="button" data-filter=".insights">Insights</li>
                            <li class="filter" data-role="button" data-filter=".research">Research</li>
                        </ul>
                    </div>
                    <div class="items-container row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all energy insights research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-8.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-8.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Energy ]</h6>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all innovation research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-9.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-9.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Research ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item all energy insights research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-10.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-10.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Insights ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all innovation research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-11.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-11.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all energy insights">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-12.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-12.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all innovation research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-13.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-13.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all energy insights">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-22.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-22.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all innovation research">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-23.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-23.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all energy insights">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/gallery/protfolio-24.jpg" alt=""></figure>
                                    <div class="overlay-content">
                                        <div class="view-btn"><a href="assets/images/gallery/protfolio-24.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zooming"></i></a></div>
                                        <div class="inner">
                                            <h6>[ Innovations ]</h6>
                                            <h5><a href="portfolio-details.html">Leading the energy transition</a></h5>
                                            <div class="link"><a href="portfolio-details.html"><i class="flaticon-right-arrow"></i></a></div>
                ...
                <div class="more-btn centred">
                    <a href="portfolio-2.html" class="theme-btn btn-one"><i class="flaticon-right-arrow"></i>Load More</a>
                </div>
            </div>
        </section>
        <!-- project-section end -->
