                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box">
                            ...
                            <div class="overlay-content">
                                <h5><a href="portfolio-details.html">Karen Residential Home</a></h5>
                                </div>
                            </div>
                            <div class="image-box">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <div class="text">
                                <h3>HOME SYSTEMS</h3>
                                <p>SENTEC solutions cut across all market segments. Home owners are part of our client base and have
                                ...
                                Impact: Reduced up to 60% on high electricity costs previously incurred by the residential home</p>
                            </div>
                        </div>
                        <div class="image-box">
                            <figure class="image image-1"><img src="assets/images/gallery/protfolio-27.jpg" alt=""></figure>
